...
>
> ~~**첫 태스크는 S4-03(마이그레이션 5차 — 증거 보존)이다.**~~ **완료.** 다음은 **S4-13(알림센터·발송 증적)** 이다 — 선행 S4-03 이 풀렸고, 이것이 열리면 S3-06 가격 변동 알림 · S3-01 커플 초대 메일 · S2-09 미가입자 초대 · S4-14 가 함께 풀린다. 병행으로 S4-01(채팅 마이그레이션)·S4-12(표준 문의·견적)도 착수 가능하다.
>
