...
| S3-03 | 업체 탐색·필터 | [ ] | S2-03, S3-01 | F-C-10, F-C-11, F-C-12. **완료 시 S2-08 대시보드의 '노출' 지표 연결** |
...
**2단계는 S2-09(미가입자 초대)만 남았고 그것은 알림 인프라(S4-13)를 기다린다.** 다음은 3단계 수요 — **S3-01**(인증·온보딩)이다. S5-01의 잔여분(결제 스케줄 테이블)은 S5-06 착수 전까지 채우면 되며 2단계를 막지 않는다.
