...
**S3-01·S3-02**(온보딩 + 커플 연동), **S3-04**(장바구니·찜 스키마·RLS), **S3-03**(업체 탐색·필터)이 끝났다.

다음은 **S3-05**(장바구니 화면)다. 선행 두 개가 모두 풀렸다. 이어서 S3-06(찜)·S3-07(비교표)이 따라온다.
...
| F-C-10 | 업체 탐색·필터·비교 | 3 | S3-03, S3-07 | 탐색·필터 완료 / 비교표는 S3-07 |
