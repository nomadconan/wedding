...
export const PRODUCT_COLUMNS =
  "id, vendor_id, category, name, base_price_total, included_items_json, capacity_min, capacity_max, status, published_at, price_includes_vat, add_ons_declared_at, summary, description_json, style_tags, lead_time_days, lead_time_note, created_at, updated_at";
